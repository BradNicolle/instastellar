...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "instastellar" because\n';
  ...
  $wnd.__gwt_activeModules['instastellar'] = {
    'moduleName' : 'instastellar',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/instastellar.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['instastellar'].superdevmode = true;

  var expectedSuffix = '/instastellar.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + instastellar + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:instastellar';
  var devModeSessionKey = '__gwtDevModeSession:instastellar';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/instastellar/instastellar.nocache.js';
  ...
  $wnd.__gwt_activeModules['instastellar'].canRedirect = true;
  $wnd.__gwt_activeModules['instastellar'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING instastellar';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/instastellar?user.agent=' + ua + '&_callback=' + callback;
